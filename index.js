...
function forCurrentWeather(response, mainDiv) {
    ...
    let textminTempInDiv1 = document.createTextNode(`Min Temp : ${response.data.forecast.forecastday[0].day.mintemp_c} ° C`)
    ...
    let textmaxTempInDiv1 = document.createTextNode(`Max Temp : ${response.data.forecast.forecastday[0].day.maxtemp_c} ° C`)
    maxTempInDiv1.appendChild(textmaxTempInDiv1)
    let precepitaionInDiv1 = document.createElement('p')
    precepitaionInDiv1.setAttribute('class', 'PrecepitationInDiv1')
    let textprecepitaionInDiv1 = document.createTextNode(`Precipitaion : ${response.data.current.precip_mm} Milimeters`)
    precepitaionInDiv1.appendChild(textprecepitaionInDiv1)

    let feelsInDiv1 = document.createElement('p')
    feelsInDiv1.setAttribute('class', 'feelsInDiv1')
    let textfeelsInDiv1 = document.createTextNode(`Feels Like : ${response.data.current.feelslike_c} ° C`)
    feelsInDiv1.appendChild(textfeelsInDiv1)
    ...
    let texthumdityInDiv1 = document.createTextNode(`Humidity : ${response.data.current.humidity}%`)
    ...
    let textwindInDiv1 = document.createTextNode(`Wind : ${response.data.current.wind_kph} Kph`)
    ...
    let textvisiblityInDiv1 = document.createTextNode(`Visiblity : ${response.data.current.vis_km} Kilometers`)
    visiblityInDiv1.appendChild(textvisiblityInDiv1)

    let uvInDiv1 = document.createElement('p')
    uvInDiv1.setAttribute('class', 'uvInDiv1')
    let textuvInDiv1 = document.createTextNode(`UV Rays : ${response.data.current.uv} Nanometers`)
    uvInDiv1.appendChild(textuvInDiv1)
    ...
    newELemDiv1.appendChild(feelsInDiv1)
    ...
    newELemDiv2.appendChild(uvInDiv1)
